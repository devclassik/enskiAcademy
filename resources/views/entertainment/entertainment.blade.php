...
<div class="main-content">
    ...
    <!-- Partner Start -->
    <div class="rs-partner black-dark pt-50 pb-50">
        <div class="container">
    ...
    <!-- About Section Start -->
    <div id="rs-about" class="rs-about pt-120 pb-120 md-pt-70 md-pb-70">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
    ...
    <!-- About Section Start -->
    <div class="rs-about style2 modify1 black-dark pt-120 pb-120 md-pt-70 md-pb-80">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 hidden-md">
                    <div class="images">
                        <img src="{{asset('assets/images/about/about-5.png')}}" alt="">
                    </div>
                </div>
    ...
    <div class="rs-why-choose  style1 black-dark pt-120 pb-120 md-pt-70 md-pb-75">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 relative hidden-md">
                    <div class="image-part">
                        <img src="{{asset('assets/images/choose/2.png')}}" alt="">
                    </div>
                    <div class="shape-animate">
                        <div class="top-shape">
                            <img class="dance" src="{{asset('assets/images/choose/dotted-2.png')}}" alt="images">
                        </div>
                        <div class="bottom-shape">
                            <img class="dance2" src="{{asset('assets/images/choose/dotted-1.png')}}" alt="images">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 pl-60 md-pl-15">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 pl-50 md-pl-15">
                    <div class="sec-title mb-50">
                        <div class="sub-text style4-bg white-color left testi">Testimonials</div>
                        <h2 class="title white-color pb-20">
                            What Viewers Saying
                        </h2>
                        <div class="desc white-color">
                    ...
                    <div class="rs-carousel owl-carousel"
                        ...
                        <div class="testi-item">
                            <div class="author-desc">
                                <div class="desc"><img class="quote" src="{{asset('assets/images/testimonial/main-home/quote2.png')}}" alt="">Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway.</div>
                            </div>
    ...
    <!-- Partner Start -->
    <div class="rs-partner style5 pt-70 pb-70">
        <div class="container">
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="5" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="2" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="3" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="3" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="5" data-md-device-nav="false" data-md-device-dots="false">
                <div class="partner-item">
                    <div class="logo-img">
