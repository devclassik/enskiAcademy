    ...
    <div class="main-content">
        ...
        <div class="full-width-header">
                        ...
                        <div class="row y-middle">
                            ...
                            <div class="col-lg-4 text-right">
                                <div class="toolbar-sl-share">
                                    <ul>
                                        <li class="opening"> <em><i class="flaticon-clock"></i> 12:01pm-6:00pm</em>
                                        </li>
                                        <li><a href="https://www.twitter.com/enski_connect"><i
                                                    class="fa fa-twitter"></i></a></li>
                                        <li><a href="https://fb.me/enski.impact.summit"><i
            ...
            <nav class="right_menu_togle hidden-md">
                <div class="close-btn"><span id="nav-close" class="text-center"><i class="fa fa-close"></i></span>
                </div>
                <div class="canvas-logo">
                    <a href="/entertainment"><img src="{{ asset('assets/images/logo-dark.png') }}"
                            alt="logo"></a>
                </div>
                ...
                <div class="canvas-contact">
                    ...
                    <ul class="contact">
                        ...
                        <li><i class="fa fa-envelope"></i><a
                                href="mailto:info@yourcompany.com">info@yourcompany.com</a></li>
                    ...
                    <div class="col-xl-8 col-lg-7 md-mb-30">
                        <div class="sec-title mb-40">
                            ...
                            <div class="desc white-color">
                                Feel free to reach out to us with your creative ideas or works, content suggestions and
                                even just for interactive purposes.
                            </div>
                        </div>
                        <div class="services-wrap mb-25">
                            ...
                            <div class="services-text">
                                ...
                                <p class="services-txt"><a
                                        href="mailto:support@enski.com.ng">entertainment@enski.com.ng</a></p>
                            </div>
                        </div>
                        <div class="services-wrap mb-25">
                            <div class="services-icon">
                            ...
                            <div class="services-text">
                                ...
                                <p class="services-txt">
                                    <a href="https://www.instagram.com/enski_impact_summit/"
                                        target="_blank">Instagram: enski_entertainment</a><br>
                                    <a href="https://t.me/enski_entertainment" target="_blank">Telegram:
                                        enski_entertainment_admin</a><br>
                                    <a href="https://fb.me/enski.impact.summit" target="_blank">Facebook: Enski
                                        Connect</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="rs-contact mod1">
                            <div class="contact-wrap">
                                ...
                                <form method="post" action="{{ url('file/upload', $id) }}"
