            ...
            <div class="topbar-area">
                <div class="container">
                    <div class="row rs-vertical-middle">
                        <div class="col-lg-2">
                            <div class="logo-part">
                                <a href="/shops"><img src="{{ asset('assets/images/logo-dark.png') }}"
                                        alt=""></a>
                            </div>
                        </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="product-thumbnail"><a href="#"><img
                                            src="{{ asset('storage') }}/{{ $courses->icon_path }}" alt=""></a>
                                </td>
                                ...
                                <td class="subtotal"><span class="amount" id="price"><span
                                            class="symbol">&#x20A6;</span>{{ number_format($courses->price) }}</span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table class="cart-total-table">
                            <tbody>
                                <tr class="cart-subtotal">
                                    <th>Subtotal</th>
                                    <td><span
                                            class="amount"><span>&#x20A6;</span>{{ number_format($courses->price) }}</span>
                                    </td>
                                </tr>
                                <tr class="order-total">
                                    <th>Total</th>
                                    <td><strong><span
                                                class="amount"><span>&#x20A6;</span>{{ number_format($courses->price) }}</span></strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
